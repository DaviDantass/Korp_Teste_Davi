...
public sealed class Product
{
    ...
    private static string NormalizeCode(string code)
    {
        ...
        if (code.Length > 50)
            throw new ArgumentException("O código deve possuir no máximo 50 caracteres.", nameof(code));
    ...
    private static string ValidateDescription(string description)
    {
        ...
        if (description.Length > 200)
            throw new ArgumentException("A descrição deve possuir no máximo 200 caracteres.", nameof(description));
