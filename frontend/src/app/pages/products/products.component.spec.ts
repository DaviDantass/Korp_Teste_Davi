...
describe('ProductsComponent', () => {
  ...
  function createComponent() {
    ...
    http.expectOne('/api/products?page=1&pageSize=10').flush(page([product]));
    fixture.detectChanges();
    return fixture;
  }
  ...
  it('creates a product through the API', () => {
    ...
    component.code = 'P-2';
    component.description = 'Produto 2';
    component.initialStock = 8;
    component.save();
    ...
    http
      .expectOne('/api/products?page=1&pageSize=10')
      .flush(
        page([product, { ...product, id: 'p2', code: 'P-2', description: 'Produto 2', stock: 8 }]),
      );
  });
  ...
  it('updates the product description through the API', () => {
    ...
    component.description = 'Produto atualizado';
    component.save();
    ...
    http
      .expectOne('/api/products?page=1&pageSize=10')
      .flush(page([{ ...product, description: 'Produto atualizado' }]));
  });

  it('sends stock entry and reloads the persisted list', () => {
    const fixture = createComponent();
    const component = fixture.componentInstance as any;
    component.openMovement(product, 'in');
    component.initialStock = 3;
  ...
  it('sends stock withdrawal and reloads the persisted list', () => {
    const fixture = createComponent();
    const component = fixture.componentInstance as any;
    component.openMovement(product, 'out');
    component.initialStock = 2;
    component.saveMovement();
