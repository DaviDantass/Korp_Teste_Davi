...
describe('ProductsComponent', () => {
  ...
  const page = (items: any[]) => ({ items, page: 1, pageSize: 10, totalItems: items.length, totalPages: 1 });
  function createComponent() { const fixture = TestBed.createComponent(ProductsComponent); fixture.detectChanges(); http.expectOne('/api/products?page=1&pageSize=10').flush(page([product])); fixture.detectChanges(); return fixture; }
  ...
  it('creates a product through the API', () => {
    ...
    http.expectOne('/api/products?page=1&pageSize=10').flush(page([product, { ...product, id: 'p2', code: 'P-2', description: 'Produto 2', stock: 8 }]));
  });
  ...
  it('updates the product description through the API', () => {
    ...
    http.expectOne('/api/products?page=1&pageSize=10').flush(page([{ ...product, description: 'Produto atualizado' }]));
  });
  ...
  it('sends stock entry and reloads the persisted list', () => {
    ...
    http.expectOne('/api/products?page=1&pageSize=10').flush(page([{ ...product, stock: 8 }]));
  });
  ...
  it('sends stock withdrawal and reloads the persisted list', () => {
    ...
    http.expectOne('/api/products?page=1&pageSize=10').flush(page([{ ...product, stock: 3 }]));
  });
});
